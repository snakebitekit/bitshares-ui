    ...
    function renderCurrentPriceIndicator(chart) {
        ...
        if (options.enabled) {
            ...
            if (!isRendered) {
                ...
                label = renderer
                    .text(
                        utils.format_number(currentPrice, options.precision),
                        x,
                        y
                    )
                    .attr({
                ...
                // box
                line = renderer
                    .path(["M", lineFrom, y, "L", x, y])
                    .attr({
                        stroke: options.lineColor,
                        "stroke-dasharray": dashStyleToArray(

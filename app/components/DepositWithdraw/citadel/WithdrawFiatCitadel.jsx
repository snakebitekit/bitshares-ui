...
class WithdrawFiatCitadel extends React.Component {
    static propTypes = {
        ...
        is_withdrawal_approved_promise
            .then(json_response => {
                if ("result" in json_response)
                    ...
                    throw "Unable to approve withdrawal, please contact Citadel or try again later";
            })
            .catch(error => {
                alert(error);
            });
...
export default BindToChainState(WithdrawFiatCitadel, {keep_updating: true});

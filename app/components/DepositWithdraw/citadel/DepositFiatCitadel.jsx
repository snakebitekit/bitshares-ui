...
class DepositFiatCitadel extends React.Component {
    static propTypes = {
        ...
        is_deposit_approved_promise
            .then(json_response => {
                if ("result" in json_response)
                    ...
                    this.setState({
                        deposit_error:
                            "Unable to approve deposit, please contact Citadel or try again later"
                    });
            })
            .catch(error => {
                this.setState({
...
export default BindToChainState(DepositFiatCitadel, {keep_updating: true});

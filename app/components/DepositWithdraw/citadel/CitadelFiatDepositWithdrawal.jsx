...
import DepositFiatCitadel from "./DepositFiatCitadel";
import WithdrawFiatCitadel from "./WithdrawFiatCitadel";

class CitadelFiatDepositWithdrawCurrency extends React.Component {
    static propTypes = {
    ...
    getWithdrawModalId() {
        return (
            "withdraw_fiat_citadel_" + this.props.receive_asset.get("symbol")
        );
    }

    getDepositModalId() {
        return "deposit_fiat_citadel_" + this.props.receive_asset.get("symbol");
    }
...
CitadelFiatDepositWithdrawCurrency = BindToChainState(
    CitadelFiatDepositWithdrawCurrency,
    {keep_updating: true}
);

class CitadelFiatDepositWithdrawal extends React.Component {
    static propTypes = {
    ...
    constructor(props) {
        ...
        // get approval status from citadel
...
CitadelFiatDepositWithdrawal = BindToChainState(CitadelFiatDepositWithdrawal, {
    keep_updating: true
});

export default CitadelFiatDepositWithdrawal;
